            ...
            <form method="POST" action="{{ route('customer.store') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
					<div class="modal-body row">
                        ...
                        <div class="form-group row">
                            <label for="ktp_image" class="col-md-4 col-form-label text-md-right">{{ __('Ktp Image') }}</label>

                            <div class="col-md-6">
                                <input id="ktp_image" type="file" class="form-control @error('ktp_image') is-invalid @enderror" name="ktp_image" required autocomplete="new-ktp_image">
